...
class smis
{
	...
	// {
	// 	echo "Inside constructor with param: $param<br>";
	// }
	...
	public function smis($AcademicYear)
	{
		...
		if (function_exists('NewADOConnection')) {
			...
			echo "Academic Year: " . $this->Academicyear;
			echo "<br>";
    ...
    */
	...
	public function GetSystemConfigurations($Academicyear = '')
	{
		...
		$SQLStmt = "SELECT * FROM hamis.room_admin_data ORDER BY academic_year DESC LIMIT 1";
	...
	public function  authenticate($Username, $Passsword)
	{
		...
		$this->MysqlSmisDB = NewADOConnection('mysql');
		$conn = $this->MysqlSmisDB->Connect('smisdbclone.uonbi.ac.ke', 'websmis', 'smis_dev_2023', 'smis');

		//if (!$conn) {
		//  die("? Failed to connect to SMIS DB: " . $this->MysqlSmisDB->ErrorMsg());
		//}
