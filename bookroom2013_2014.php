	...
	if ($Loggedin) {
		if(strlen($_SESSION['session'])==0)
		{
			 ...
			 if(($LevelofStudy < 1) && $StudentCategory == '001'){
			 	echo '<tr><td><li><a href=?session=next&AcademicYear=2014/2015>Regular Student Room Application and Confirmation for Academic Year <font color = "red">2014/2015 </font></a></td></li></tr>';
			 ...
			 if($StudentCategory == '001' && $LevelofStudy >= 1){
				 echo '<tr><td><li><a href=?session=next&AcademicYear=2014/2015>Regular Student Room Application and Confirmation for Academic Year <font color = "red">2014/2015 </font></a></td></li></tr>';
				 echo '<tr><td><li><a href=?session=in>Regular Student Room Application and Confirmation for current Academic Year</a></td></li></tr>';
