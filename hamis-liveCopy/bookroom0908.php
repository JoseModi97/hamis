...
?>
	...
	if ($Loggedin) {
		if(strlen($_SESSION['session'])==0)
		{
			 ...
			 if(($LevelofStudy = 1) && $StudentCategory == '001' && $AcademicYear='2017/2018' && $KcseYear ='2015'){
				 
				//print $KcseYear;
				//print $AcademicYear;
				 
			 	echo '<tr><td><li><a href=?session=next&AcademicYear=2017/2018>Regular Students Room Application and Confirmation for <font color = "red">2017/2018</font> Academic Year </a></td></li></tr>';
			 ...
			 else if($StudentCategory == '001' && $LevelofStudy >= 1 && $AcademicYear='2016/2017' && $KcseYear !='2015'){
				 //print $KcseYear;
			  //exit;
				 //echo '<tr><td><li><a href=?session=next&AcademicYear=2017/2018>Regular Student Room Application and Confirmation for Academic Year <font color = "red">2017/2018</font></a></td></li></tr>';
				 echo '<tr><td><li><a href=?session=in&AcademicYear=2016/2017>Regular Students Room Application and Confirmation for <font color = "red">2016/2017</font> Academic Year</a></td></li></tr>';
				 
				 echo '<tr><td><li><a href=?session=out>Vacational Room Application and Confirmation for current Academic Year</a></li></td></tr>';
			}
			else if($StudentCategory != '001'){
			...
			echo '<tr><td><a href=?home=yes ><font size="+0.5" color="blue">CLICK TO GO BACK TO MAIN MENU</font></a></td></tr>';
			echo '</table>';
		}
